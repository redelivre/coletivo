...
function onepress_widgets_init() {
	register_sidebar( 
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__('Default sidebar for blog template', 'onepress'),
	...
	register_sidebar(
		...
		'id'            => 'sidebar-2',
		'description'   => esc_html__('Sidebar for template With Sidebar', 'onepress'),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
function onepress_scripts() {
    ...
    if ( ! $galley_disable || is_customize_preview() ) {
        ...
        if ( ! is_customize_preview() ) {
            switch ( $display ) {
                case 'masonry':
                    wp_enqueue_script('onepress-gallery-masonry', get_template_directory_uri() . '/assets/js/isotope.pkgd.min.js');
                    break;
                case 'justified':
                    wp_enqueue_script('onepress-gallery-justified', get_template_directory_uri() . '/assets/js/jquery.justifiedGallery.min.js');
                    break;
                case 'slider':
                case 'carousel':
                    wp_enqueue_script('onepress-gallery-carousel', get_template_directory_uri() . '/assets/js/owl.carousel.min.js');
                    break;
                default:
                    break;
            }
	...
	wp_enqueue_script( 'onepress-theme', get_template_directory_uri() . '/assets/js/theme.js' );
	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
