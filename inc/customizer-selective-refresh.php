<?php
/**
 * Coletivo Customizer Selective Refresh
 *
 * @package Coletivo
 */
 ...
 * @since 1.2.1
 *
 * @param string $template_names The file names of templates.
 *
 * @return string
 */
 ...
 * @since 1.2.1
 *
 * @param string $section_tpl The template file name.
 ...
 * @since 1.2.1
 *
 * @param Object|array $wp_customize The customizer object.
 */
 ...
 *
 * @param Object|int $partial           The partial section.
 * @param array      $container_context Container array.
 */
...
/**
 * Selective refresh social footer title
 */
...
/**
 * Selective refresh featured page
 *
 * @param Object|int $partial           The partial section.
 * @param array      $container_context Container array.
 */
function coletivo_selective_refresh_featured_page( $partial = '', $container_context = '' ) {
	return coletivo_get_customizer_section_content(
		array(
			'section-parts/section-featuredpage.php',
		),
		array()
	);
}
