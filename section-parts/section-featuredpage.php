...
$coletivo_featuredpage_bg_disable   = get_theme_mod( 'coletivo_featuredpage_bg_disable' );
...
if ( ! empty( $page_ids ) ) {
    ...
    <?php if (!$coletivo_featuredpage_disable) { ?>
        ...
        <?php if ($coletivo_featuredpage_bg_disable != '0') { ?>
        ...
        <section id="<?php if ($coletivo_featuredpage_id != '') {
        ...
        <?php if ($coletivo_featuredpage_bg_disable != '1') { ?>
        ...
        <section style="<?php echo esc_attr( $style );?>" id="<?php if ($coletivo_featuredpage_id != '') {
            echo $coletivo_featuredpage_id;
        }; ?>" <?php do_action('coletivo_section_atts', 'featuredpage'); ?> class="<?php echo esc_attr(apply_filters('coletivo_section_class', 'section-featuredpage with-image section-padding onepage-section', 'featuredpage')); ?>">
            <?php endif;?>
        <?php } ?>
