	...
	if ( ! $coletivo_contact_disable ) {
		...
		<div class="container">
			...
			<div class="section-title-area">
				<?php
				if ( '' !== $coletivo_contact_subtitle ) {
					echo '<h5 class="section-subtitle">' . esc_html( $coletivo_contact_subtitle ) . '</h5>';
				}

				if ( '' !== $coletivo_contact_title ) {
					echo '<h2 class="section-title">' . esc_html( $coletivo_contact_title ) . '</h2>';
				}
			...
			<div class="row">
				<?php
				if ( '1' !== $coletivo_contact_cf7_disable ) {
					$classe = 'col-sm-6';
				...
				<div class="<?php echo esc_attr( $classe ); ?> wow slideInUp">
						<h3>
							<?php
							if ( '' !== $coletivo_contact_address_title ) {
								echo wp_kses_post( $coletivo_contact_address_title );
							}
							?>
						</h3>
						<div class="contact-text">
							<?php
							if ( '' !== $coletivo_contact_text ) {
								echo wp_kses_post( $coletivo_contact_text );
							}
							?>
						</div>
						...
						<?php if ( '' !== $coletivo_contact_whats ) { ?>
							<div class="address-contact">
								...
								<div class="address-content">
									...
									?>
									<a target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo esc_attr( $coletivo_contact_whats_number ); ?>"><?php echo wp_kses_post( $coletivo_contact_whats ); ?></a>
								</div>
							</div>
						<?php } ?>
