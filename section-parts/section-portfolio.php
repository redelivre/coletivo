...
?>
<?php if ( ! $coletivo_portfolio_disable  ) :

$desc = get_theme_mod( 'coletivo_portfolio_desc' );
?>
<?php if ( ! coletivo_is_selective_refresh() ){ ?>
<section id="<?php if ( $coletivo_portfolio_id != '' ) echo $coletivo_portfolio_id; ?>" <?php do_action( 'coletivo_section_atts', 'portfolio' ); ?> class="<?php echo esc_attr( apply_filters( 'coletivo_section_class', 'section-portfolio section-padding onepage-section', 'portfolio' ) ); ?>">
<?php } ?>
	...
	<div class="container">
		...
		<div class="section-title-area">
			<?php if ( $coletivo_portfolio_subtitle != '' ) echo '<h5 class="section-subtitle">' . esc_html( $coletivo_portfolio_subtitle ) . '</h5>'; ?>
			<?php if ( $coletivo_portfolio_title != '' ) echo '<h2 class="section-title">' . esc_html( $coletivo_portfolio_title ) . '</h2>'; ?>
            <?php if ( $desc ) {
				...
				<div class="col-sm-12">
					<div class="blog-entry wow slideInUp">
						...
						<div class="all-portfolio">
							<a class="btn btn-theme-primary btn-lg" href="<?php echo esc_url($coletivo_portfolio_more_link) ?>"><?php if ( $coletivo_portfolio_more_text != '' ) echo esc_html( $coletivo_portfolio_more_text ); ?></a>
						</div>
						<?php } ?>
	...
	<?php do_action( 'coletivo_section_after_inner', 'portfolio' ); ?>
<?php if ( ! coletivo_is_selective_refresh() ){ ?>
</section>
<?php } ?>
<?php endif;
